...
def main():
    ...
    train_agent(next(train_dataset))  # 这一段必须，用于加入所有的网络层
    ...
    if (logdir / "variables.pkl").exists():
        ...
        if config.load_logdir != "none":
            ...
            if "mae_encoder" in config.load_modules:
                agnt.wm.mae_encoder.load(load_logdir / "mae_encoder_variables.pkl")
            if "mae_decoder" in config.load_modules:
                agnt.wm.mae_decoder.load(load_logdir / "mae_decoder_variables.pkl")
            if "vit_encoder" in config.load_modules:
                agnt.wm.wm_vit_encoder.load(load_logdir / "wm_vit_encoder_variables.pkl")
            if "vit_decoder" in config.load_modules:
                agnt.wm.wm_vit_decoder.load(load_logdir / "wm_vit_decoder_variables.pkl")
